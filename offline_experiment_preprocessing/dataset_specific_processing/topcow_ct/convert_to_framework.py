...
def process_topcowct_dataset(
    ...
    """
    Process TopCOW-CT dataset with label-based instance separation.
    ...
    target_dataset_name = f"Dataset{dataset_id:03d}_TopCowCT"
    ...
    dataset_json = {
        "name": "TopCOW-CT",
        "description": "TopCOW-CT dataset for circle of willis segmentation",
        "tensorImageSize": "3D",
...
if __name__ == "__main__":
    input_directory = "/home/parhomesmaeili/Radiology_Datasets/topcow2024_ct"  # Update this path
    
    dataset_id = 32  # Adjust as needed
    num_processes = 8

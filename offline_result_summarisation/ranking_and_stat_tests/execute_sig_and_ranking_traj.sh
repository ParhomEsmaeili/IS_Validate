...
# Base paths
BASIC_RESULTS_SUMMARY_ROOT="/home/parhomesmaeili/IS-Validation-Framework/Results_Summary/$SPLIT_NAME"
TRAJ_RESULTS_SUMMARY_ROOT="/home/parhomesmaeili/IS-Validation-Framework/Results_Pseudotime/$SPLIT_NAME"
#BASICSTATS_SIG_OUTPUT_ROOT="/home/parhomesmaeili/IS-Validation-Framework/Results_StatSig/$SPLIT_NAME/$CONFIG_NAME/snapshot"
TRAJ_STATS_SIG_OUTPUT_ROOT="/home/parhomesmaeili/IS-Validation-Framework/Results_StatSig/$SPLIT_NAME/$CONFIG_NAME"
#BASICRANKING_OUTPUT_ROOT="/home/parhomesmaeili/IS-Validation-Framework/Results_Ranking/$SPLIT_NAME/$CONFIG_NAME/snapshot"
TRAJ_RANKING_OUTPUT_ROOT="/home/parhomesmaeili/IS-Validation-Framework/Results_Ranking/$SPLIT_NAME/$CONFIG_NAME"
...
for DATASET_NAME in "${DATASET_NAMES[@]}"; do
    TRAJ_SIG_SUBPATHS+=("$DATASET_NAME/$PROMPTER/run$RUN_NAME/pseudotime_metrics")
done
...
echo "=============================================="
echo "Running Trajectory Algorithm-wise Significance Scoring"
echo "=============================================="
echo "Configuration:"
echo "  Split: $SPLIT_NAME"
echo "  Apps: ${APPS[@]}"
echo "  Datasets: ${DATASET_NAMES[@]}"
echo "  Input Root: $TRAJ_RESULTS_SUMMARY_ROOT"
echo "  Output Root: $TRAJ_STATS_SIG_OUTPUT_ROOT"
echo "  Config Name: $CONFIG_NAME"
echo "=============================================="
# Run significance scoring for the trajectory.
python3 $SCRIPT_DIR/trajectory_algo_wise_sig_score.py \
    --case_name_bool \
    --dataset_names "${DATASET_NAMES[@]}" \
    --metrics_root "$TRAJ_RESULTS_SUMMARY_ROOT" \
    --metrics_config "${TRAJ_SIG_METRICS_CONFIG}" \
    --algorithm_names "${APPS[@]}" \
    --experiment_subpath "${TRAJ_SIG_SUBPATHS[@]}" \
    --output_root "$TRAJ_STATS_SIG_OUTPUT_ROOT"
...
echo ""
echo "=============================================="
echo "Running Trajectory Algorithm Ranking Generation"
echo "=============================================="
echo "Configuration:"
echo "  Split: $SPLIT_NAME"
echo "  Apps: ${APPS[@]}"
echo "  Datasets: ${DATASET_NAMES[@]}"
echo "  Input Root: $TRAJ_STATS_SIG_OUTPUT_ROOT"
echo "  Output Root: $TRAJ_RANKING_OUTPUT_ROOT"
echo "=============================================="



# Run ranking generation for trajectory
python3 $SCRIPT_DIR/generate_algo_rankings.py \
    --ref_root "$TRAJ_STATS_SIG_OUTPUT_ROOT" \
    --metrics "${RANKING_METRICS[@]}" \
    --task_names "${DATASET_NAMES[@]}" \
    --algorithm_names "${APPS[@]}" \
    --output_root "$TRAJ_RANKING_OUTPUT_ROOT"
...
echo "=============================================="
echo "Output locations for trajectory:"
echo "  Significance Scores: $TRAJ_STATS_SIG_OUTPUT_ROOT"
echo "  Rankings: $TRAJ_RANKING_OUTPUT_ROOT"
echo "=============================================="
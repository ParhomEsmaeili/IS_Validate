...
#BASICSTATS_SIG_OUTPUT_ROOT="$MASTER_RESULTS_ROOT/Results_StatSig/$SPLIT_NAME/$CONFIG_NAME/snapshot"
TRAJ_STATS_SIG_OUTPUT_ROOT="$MASTER_RESULTS_ROOT/Results_StatSig/$SPLIT_NAME/$CONFIG_NAME"
#BASICRANKING_OUTPUT_ROOT="$MASTER_RESULTS_ROOT/Results_Ranking/$SPLIT_NAME/$CONFIG_NAME/snapshot"

...
echo "=============================================="
echo "Running Algorithm-wise Pseudo-time AUC Plotter for aggregated runs."
APPS=("${MASTER_APPS[@]}")
...
for index in ${!DATASET_NAMES[@]}; do
  DATASET_NAME=${DATASET_NAMES[$index]};
    ...
    for RUN_NUM in "${RUN_NUMS[@]}"; do
        ...
        echo APPS: "${APPS[@]}";
        python3 $SCRIPT_DIR/"plot_pseudotime_auc.py" \
            ...
            --nnunet_result_root="$REFERENCE_RESULT_ROOT" \

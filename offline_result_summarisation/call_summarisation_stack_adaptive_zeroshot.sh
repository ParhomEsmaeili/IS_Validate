...
declare -ax MASTER_DICE_ITERATION_STATISTIC=("mean") #("median") #("mean") #("median") #The statistic which we report/determine betterness with.
declare -ax MASTER_NSD_ITERATION_STATISTIC=("mean") #("median") #("mean") #("median") #The statistic which we report/determine betterness with.
...
declare -ax MASTER_APPS=("adatest2") #"adatest4" "adatest5" "adatest6") #("adatest2")
...
declare -ax MASTER_APPS=("nnintv1" "adatest2") #"adatest2" "adatest4" "adatest5" "adatest6") #"adatest2")
declare -ax MASTER_RUN_NUMS=("1" "2" "3")
...
# # declare -ax MASTER_APPS=("sammed2dv1" "sam2v1" "segvolv1" "sammed3dv1" "nnintv1") 
declare -ax MASTER_APPS=("nnintv1" "adatest2") #"adatest4" "adatest5" "adatest6") #"adatest3")

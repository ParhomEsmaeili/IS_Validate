...
def process_topbrainMR_dataset(
    dataset_dir, 
    output_dir, 
    dataset_id, 
    semantic_class_mapping,
    ...
    """
    Process topbrain-MR dataset with label-based instance separation.
    ...
    target_dataset_name = f"Dataset{dataset_id:03d}_TopBrainMR"
    ...
    dataset_json = {
        "name": "TopBrainMR",
        "description": "TopBrainMR dataset for brain vessel segmentation",
        "tensorImageSize": "3D",
...
if __name__ == "__main__":
    input_directory = "/home/parhomesmaeili/Radiology_Datasets/topbrain_mr"  # Update this path
    
    dataset_id = 45  # Adjust as needed
    num_processes = 8

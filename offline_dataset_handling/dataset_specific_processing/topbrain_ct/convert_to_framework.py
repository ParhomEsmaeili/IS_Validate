...
def process_topbrainct_dataset(
    dataset_dir, 
    output_dir, 
    dataset_id, 
    semantic_class_mapping,
    ...
    """
    Process Topbrain-CT dataset with label-based instance separation.
    ...
    target_dataset_name = f"Dataset{dataset_id:03d}_TopBrainCT"
    ...
    dataset_json = {
        "name": "topbrain-CT",
        "description": "topbrain-CT dataset for brain vessel segmentation",
        "tensorImageSize": "3D",
...
if __name__ == "__main__":
    input_directory = "/home/parhomesmaeili/Radiology_Datasets/topbrain_ct"  # Update this path
    
    dataset_id = 44  # Adjust as needed
    num_processes = 8
